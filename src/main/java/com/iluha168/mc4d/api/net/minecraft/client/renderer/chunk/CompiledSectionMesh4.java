package com.iluha168.mc4d.api.net.minecraft.client.renderer.chunk;
...
public interface CompiledSectionMesh4 {
	...
	/**
	 * Sorted distinct block-local camera W values, scaled to (0;{@value com.iluha168.mc4d.api.net.minecraft.client.renderer.block.dispatch.Variant4#W_SCALE}),
