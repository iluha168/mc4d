...
@Mixin(AshParticle.class)
abstract class AshParticleMixin extends BaseAshSmokeParticleMixin {
	@Mixin(AshParticle.Provider.class)
	abstract static class ProviderMixin implements ParticleProvider<SimpleParticleType>, ParticleProvider4<SimpleParticleType> {
		...
		public @Nullable Particle createParticle(SimpleParticleType options, ClientLevel level, double x, double y, double z, double w, double xAux, double yAux, double zAux, double wAux, RandomSource random) {
			...
			((BaseAshSmokeParticle4) particle).init_finish(w, 0.1F, -0.1F, 0.1F, 0.1F, 0.0, 0.0, 0.0, 0.0);
			return particle;
		}
	}
}
